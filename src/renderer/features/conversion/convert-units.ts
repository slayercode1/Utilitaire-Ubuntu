...
export function tryConversion(query: string): ConversionResult | null {
  ...
  const conversions: ConversionTable = {
    ...
    // ===== TEMPÉRATURES =====
    'temperature': {
      'c': { 'f': (v: number) => v * 9/5 + 32, '°f': (v: number) => v * 9/5 + 32, 'k': (v: number) => v + 273.15 },
      '°c': { 'f': (v: number) => v * 9/5 + 32, '°f': (v: number) => v * 9/5 + 32, 'k': (v: number) => v + 273.15 },
      'f': { 'c': (v: number) => (v - 32) * 5/9, '°c': (v: number) => (v - 32) * 5/9, 'k': (v: number) => (v - 32) * 5/9 + 273.15 },
      '°f': { 'c': (v: number) => (v - 32) * 5/9, '°c': (v: number) => (v - 32) * 5/9, 'k': (v: number) => (v - 32) * 5/9 + 273.15 },
      'k': { 'c': (v: number) => v - 273.15, '°c': (v: number) => v - 273.15, 'f': (v: number) => (v - 273.15) * 9/5 + 32, '°f': (v: number) => (v - 273.15) * 9/5 + 32 }
    },
    ...
    'web': {
      ...
      'rem': { 'px': (v, base = 16) => v * base, 'em': (v: number) => v, 'pt': (v, base = 16) => v * base * 0.75, 'cm': (v, base = 16) => v * base * 0.0264583, 'mm': (v, base = 16) => v * base * 0.264583, 'in': (v, base = 16) => v * base * 0.0104167 },
      'em': { 'px': (v, base = 16) => v * base, 'rem': (v: number) => v, 'pt': (v, base = 16) => v * base * 0.75, 'cm': (v, base = 16) => v * base * 0.0264583, 'mm': (v, base = 16) => v * base * 0.264583, 'in': (v, base = 16) => v * base * 0.0104167 },
  ...
  for (const table of Object.values(conversions)) {
    ...
    if (factor !== undefined) {
      ...
      const result =
        typeof factor === 'function' ? factor(value) : value * factor
